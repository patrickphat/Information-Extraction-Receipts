...
class TextImageGenerator:
    def __init__(self, img_dirpath,label_path, img_w, img_h,
    ...
    def build_data(self):
        ...
        print(self.n, " Labels Loading start...")
        ...
        for i, img_file in tqdm_notebook(enumerate(self.img_dir)):
            print("Finished {}/{} images".format(i+1,self.n))
            ...
            self.imgs[i, :, :] = img
            self.texts.append(labels[int(img_file[:-4])])
